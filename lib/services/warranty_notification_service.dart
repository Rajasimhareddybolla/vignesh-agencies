...
class WarrantyNotificationService {
  ...
  static const String _scheduledNotificationsKey = 'scheduled_warranty_notifications';
  ...
  static Future<void> scheduleWarrantyNotifications(
    ...
    for (final appliance in appliances) {
      ...
      await _scheduleNotification(
        ...
        body: 'Your ${appliance.productName} warranty expires in $_daysBeforeExpiry days. '
  ...
  static Future<void> checkAndScheduleNotifications(
    ...
    final activeAppliances = appliances.where(
      (a) => a.status == ProductStatus.active && a.isUnderWarranty,
    ).toList();
